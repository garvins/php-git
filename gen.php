...
function additionalFunctioToFile($fileName)
{
    ...
    if ($fileName == "blame.h" || $fileName == "blame.c") {
        ...
        $func .= "\tfilter->attributes = php_git2_read_arrval_string(mixed, ZEND_STRL(\"attributes\") TSRMLS_CC);\n\n";
        $func .= "\tif (tmp = php_git2_read_arrval(mixed, ZEND_STRL(\"initialize\") TSRMLS_CC)) {\n";
        $func .= "\t\tphp_git2_fcall_info_wrapper2(tmp, &initialize_fci, &initialize_fcc TSRMLS_CC);\n";
        $func .= "\t}\n\n";
        $func .= "\tif (tmp = php_git2_read_arrval(mixed, ZEND_STRL(\"shutdown\") TSRMLS_CC)) {\n";
        $func .= "\t\tphp_git2_fcall_info_wrapper2(tmp, &shutdown_fci, &shutdown_fcc TSRMLS_CC);\n";
        $func .= "\t}\n\n";
        $func .= "\tif (tmp = php_git2_read_arrval(mixed, ZEND_STRL(\"check\") TSRMLS_CC)) {\n";
        $func .= "\t\tphp_git2_fcall_info_wrapper2(tmp, &check_fci, &check_fcc TSRMLS_CC);\n";
        $func .= "\t}\n\n";
        $func .= "\tif (tmp = php_git2_read_arrval(mixed, ZEND_STRL(\"apply\") TSRMLS_CC)) {\n";
        $func .= "\t\tphp_git2_fcall_info_wrapper2(tmp, &apply_fci, &apply_fcc TSRMLS_CC);\n";
        $func .= "\t}\n\n";
        $func .= "\tif (tmp = php_git2_read_arrval(mixed, ZEND_STRL(\"cleanup\") TSRMLS_CC)) {\n";
        ...
        $func .= "\ttmp = php_git2_read_arrval(callbacks, ZEND_STRL(\"read\") TSRMLS_CC);\n";
        $func .= "\tif (tmp) {\n";
        $func .= "\t\tphp_git2_fcall_info_wrapper2(tmp, &read_fci, &read_fcc TSRMLS_CC);\n";
        $func .= "\t}\n\n";
        $func .= "\ttmp = php_git2_read_arrval(callbacks, ZEND_STRL(\"write\") TSRMLS_CC);\n";
        $func .= "\tif (tmp) {\n";
        $func .= "\t\tphp_git2_fcall_info_wrapper2(tmp, &write_fci, &write_fcc TSRMLS_CC);\n";
        $func .= "\t}\n\n";
        $func .= "\ttmp = php_git2_read_arrval(callbacks, ZEND_STRL(\"read_header\") TSRMLS_CC);\n";
        $func .= "\tif (tmp) {\n";
        $func .= "\t\tphp_git2_fcall_info_wrapper2(tmp, &read_header_fci, &read_header_fcc TSRMLS_CC);\n";
        $func .= "\t}\n\n";
        $func .= "\ttmp = php_git2_read_arrval(callbacks, ZEND_STRL(\"read_prefix\") TSRMLS_CC);\n";
        $func .= "\tif (tmp) {\n";
        $func .= "\t\tphp_git2_fcall_info_wrapper2(tmp, &read_prefix_fci, &read_prefix_fcc TSRMLS_CC);\n";
        $func .= "\t}\n\n";
        $func .= "\ttmp = php_git2_read_arrval(callbacks, ZEND_STRL(\"exists\") TSRMLS_CC);\n";
        $func .= "\tif (tmp) {\n";
        $func .= "\t\tphp_git2_fcall_info_wrapper2(tmp, &exists_fci, &exists_fcc TSRMLS_CC);\n";
        $func .= "\t}\n\n";
        $func .= "\ttmp = php_git2_read_arrval(callbacks, ZEND_STRL(\"foreach\") TSRMLS_CC);\n";
        $func .= "\tif (tmp) {\n";
        $func .= "\t\tphp_git2_fcall_info_wrapper2(tmp, &foreach_fci, &foreach_fcc TSRMLS_CC);\n";
        $func .= "\t}\n\n";
        $func .= "\ttmp = php_git2_read_arrval(callbacks, ZEND_STRL(\"free\") TSRMLS_CC);\n";
        $func .= "\tif (tmp) {\n";
        $func .= "\t\tphp_git2_fcall_info_wrapper2(tmp, &free_fci, &free_fcc TSRMLS_CC);\n";
        $func .= "\t}\n\n";
        $func .= "\ttmp = php_git2_read_arrval(callbacks, ZEND_STRL(\"refresh\") TSRMLS_CC);\n";
        $func .= "\tif (tmp) {\n";
